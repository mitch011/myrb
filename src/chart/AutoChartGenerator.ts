 ...
 * Hard keeps essentially everything; Medium and Easy are gap-thinned
 * subsets (not literally "every Nth note") so the patterns stay musically
 * plausible rather than mechanically decimated.
 */
